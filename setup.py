...
try:
	...
	print("A error happend? i am going to try to fix it for you wait a second.")
	...
	print("Try it now, if i didn't work, contact azgard on github, bye !")
	time.sleep(1)
	sys.exit()
except IOError:
	os.system("clear")
	...
	os.system("sudo python -m pip install urllib2")
	os.system("sudo python -m pip install colorama")
	os.system("sudo python -m pip install BeautifulSoup")
	os.system("sudo python -m pip install beautifulsoup4")
	os.system("sudo python3 -m pip install google")
	os.system("sudo python3 -m pip install urllib2")
	os.system("sudo python3 -m pip install colorama")
	os.system("sudo python3 -m pip install BeautifulSoup")
